    ...
    className='flex items-center justify-center'>
        ...
        className='max-w-3xl'>
            ...
            className='flex-col'>
                ...
                Sometimes the Fusiform face area can become active when no actual face is present. This is called Pareidolia, a phenomenon where we perceive a face where there is no actual face.</p>
